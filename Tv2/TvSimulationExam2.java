...
public class TvSimulationExam2 {
    public static void main(String[] args) {
        ...
        a표준Tv = a샤오미Tv;
        a표준Tv.이름세팅(); // 이름세팅이라는 함수의 사용이 꼭 필요하지만 실수로 빼먹을 경우 오류나 버그가 발생하 수 있다.
        a표준Tv.켜기();
        // 출력 : 샤오미TV 켜집니다.
        a표준Tv.끄기();
        // 출력 : 샤오미TV 꺼집니다.
...
class 표준Tv{ // 추상클레스  // lg,삼성tv 들은 구체적인 tv인데 표준tv는 추상적으로 공통적인 tv이기에
    String brand;
    void 이름세팅() {}
    void 켜기() { System.out.println( brand + " 켜집니다."); }
    public void 끄기() {}
}
...
class 샤오미Tv extends 표준Tv { // 표준tv에게 물려받은 켜기 메서드가 내용이 없는 추상메서드이기 때문에 오버라이딩 하지 않으면 실행 할 수 없음.
    ...
    void 이름세팅() {
        brand = "샤오미tv"; // 표준tv에게 물려받은 brand변수와는 다르다. 샤유미Tv에게만 있는 변수이다.
    }
